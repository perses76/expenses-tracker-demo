...
NOTE: Please keep in mind that this is the project that will be used to evaluate your skills. We will evaluate the project as if you are delivering it to a customer. We expect you to make sure that the app is fully functional and doesn’t have any obvious missing pieces. The deadline for the project is 2 weeks from today.
